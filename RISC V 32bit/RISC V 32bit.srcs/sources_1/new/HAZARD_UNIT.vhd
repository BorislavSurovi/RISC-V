...
begin
    ...
    process(rs1_address_id_i, rs2_address_id_i, rd_address_ex_i, rs1_in_use_i, rs2_in_use_i, mem_to_reg_ex_i, rd_we_ex_i, branch_id_i, rd_address_mem_i, mem_to_reg_mem_i)
    begin
    
        if_id_en_o <= '1'; --propustaju na 1
        pc_en_o <= '1';
        control_pass_o <= '1'; --resetuje na 0
